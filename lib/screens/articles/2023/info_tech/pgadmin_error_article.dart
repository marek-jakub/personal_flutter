...
class PgadminErrorArticle extends StatefulWidget {
  const PgadminErrorArticle({Key? key}) : super(key: key);

  @override
  State<PgadminErrorArticle> createState() => _ProviderErrorArticleState();
}

class _ProviderErrorArticleState extends State<PgadminErrorArticle> {
  @override
  ...
  Future<String> getArticle() async {
    final String article = await rootBundle
        .loadString('assets/articles/2023/02_article/article_14Nov2023.md');
    return article;
  }
}
