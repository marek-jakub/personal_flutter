...
class ProviderErrorArticle extends StatefulWidget {
  const ProviderErrorArticle({Key? key}) : super(key: key);

  @override
  State<ProviderErrorArticle> createState() => _ProviderErrorArticleState();
}

class _ProviderErrorArticleState extends State<ProviderErrorArticle> {
  @override
  ...
  Future<String> getArticle() async {
    final String article = await rootBundle
        .loadString('assets/articles/2023/01_article/article_24Oct2023.md');
    return article;
  }
}
