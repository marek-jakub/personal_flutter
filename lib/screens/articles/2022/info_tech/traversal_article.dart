...
class TraversalArticle extends StatefulWidget {
  const TraversalArticle({Key? key}) : super(key: key);

  @override
  State<TraversalArticle> createState() => _TraversalArticleState();
}

class _TraversalArticleState extends State<TraversalArticle> {
  @override
  ...
  Future<String> getArticle() async {
    final String article = await rootBundle
        .loadString('assets/articles/2022/03_article/article_17Jul2022.md');
    return article;
  }
}
